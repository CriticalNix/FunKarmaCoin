...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FunKarmaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"funkarmacointools.com", "dnsseed.funkarmacointools.com"},
    {"funkarmacoinpool.org", "dnsseed.funkarmacoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"funkarmacointools.com", "testnet-seed.funkarmacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FunKarmaCoin is probably already running."), addrBind.ToString().c_str());
        else
