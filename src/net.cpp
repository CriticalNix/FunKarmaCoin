...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FunKarma " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"FunKarmatools.com", "dnsseed.FunKarmatools.com"},
    {"FunKarmapool.org", "dnsseed.FunKarmapool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"FunKarmatools.com", "testnet-seed.FunKarmatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FunKarma is probably already running."), addrBind.ToString().c_str());
        else
